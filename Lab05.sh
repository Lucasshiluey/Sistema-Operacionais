...
lucas-lindo@lucas-lindo-VirtualBox:~$ nano firewall.ssh
lucas-lindo@lucas-lindo-VirtualBox:~$ nano firewall.ssh
lucas-lindo@lucas-lindo-VirtualBox:~$ chmod +x firewall.ssh
lucas-lindo@lucas-lindo-VirtualBox:~$ sudo ./firewall.sh
...
lucas-lindo@lucas-lindo-VirtualBox:~$ sudo ./firewall.ssh
...
lucas-lindo@lucas-lindo-VirtualBox:~$ sudo apt-get install squid
...
lucas-lindo@lucas-lindo-VirtualBox:~$ sudo nano /etc/squid/sites_bloqueados.txt
lucas-lindo@lucas-lindo-VirtualBox:~$ sudo nano /etc/squid/squid.conf

# 3 Reiniciar e Testar
lucas-lindo@lucas-lindo-VirtualBox:~$ sudo systemctl restart squid
